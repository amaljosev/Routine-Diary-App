      ...
      body: Padding(
        ...
        child: Column(
          children: [
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      ...
                                      spreadRadius: _currentPage == index
                                          ? 2
                                          : 0,
                                    ),
                                  ],
                                                  ...
                                                  child: Row(
                                                    crossAxisAlignment:
                                                        CrossAxisAlignment
                                                            .center,
                                                    children: [
                                                      // Date indicator shimmer with gradient - smaller
                                                      Container(
                                                        width: 45,
                                                        height: 45,
                                                        decoration: BoxDecoration(
                                                      ...
                                                      // Content shimmer with gradients
                                                      Expanded(
                                                        child: Column(
                                                          crossAxisAlignment:
                                                              CrossAxisAlignment
                                                          ...
                                                          mainAxisAlignment:
                                                              MainAxisAlignment
                                                                  .center,
                                                          children: [
                                                            // Row with mood and title - smaller
                                                            Row(
                                                              children: [
                                                                // Mood emoji shimmer with gradient - smaller
                                                                Container(
                                                                  width: 24,
                                                                  height: 24,
                                                                  decoration: BoxDecoration(
                                                                ...
                                                                // Title shimmer with gradient - smaller
                                                                Expanded(
                                                                  child: Container(
                                                                    height: 18,
                                                                    decoration: BoxDecoration(
                                                            ...
                                                            // Preview text shimmers with gradients - only 2 lines
                                                            Container(
                                                              height: 12,
                                                              width: double
                                                                  .infinity,
                                                            ...
                                                            // Time shimmer with gradient - smaller
                                                            Row(
                                                              children: [
                                                                Container(
                                                                  width: 12,
            ...
            // Bottom section with Use It button
            SafeArea(
              child: SizedBox(
                width: double.infinity,
                height: 60,
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          'Theme for ${_themes[_selectedThemeIndex]} selected!',
